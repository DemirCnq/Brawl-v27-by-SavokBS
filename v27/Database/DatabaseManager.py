...
class DataBase:
    ...
    def loadAccount(self):
        ...
        if user_data:
            ...
            self.player.brawl_pass_tokens = user_data[0]["info"]["BrawlPassTokens"]
            self.player.brawl_pass_level = user_data[0]["info"]["BrawlPassLVL"]
            self.player.free_pass_level = user_data[0]["info"]["FreePassLVL"]
            self.player.brawl_pass_unlocked = user_data[0]["info"]["BrawlPassUnlocked"]
            ...
            self.player.reward_trophy_road = user_data[0]["info"]["TrophyReward"]
            ...
            "info":
                {
                    ...
                    "BrawlPassTokens": self.player.brawl_pass_tokens,
                    "BrawlPassLVL": self.player.brawl_pass_level,
                    "FreePassLVL": self.player.free_pass_level,
                    "BrawlPassUnlocked": self.player.brawl_pass_unlocked,
                    ...
                    "TrophyReward": self.player.reward_trophy_road,
                    "DoNotDistrub": 0,
                    "roomID": 0,
