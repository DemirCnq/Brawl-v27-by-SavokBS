...
#from Packets.Messages.Server.Battle.BattleResult3Message import BattleResult3Message
...
class AskForBattleEndMessage(BSMessageReader):
    ...
    def decode(self):
        ...
        self.read_Vint() # tokens 
        self.read_Vint() # trophies
        self.read_Vint() # doubled trophies
        self.read_Vint() # remaining tokens
        self.read_Vint() # ?
        self.read_Vint() # Battle Result Info
        self.read_Vint() # Players
